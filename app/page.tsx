                ...
                <div className='mx-auto max-w-6xl px-4 py-12'>
                    <div className='grid gap-8 sm:grid-cols-2 lg:grid-cols-4'>
                        ...
                        <div className='lg:col-span-1'>
                            <p className='text-lg font-bold tracking-tight text-white'>HooBu</p>
                    ...
                    <div className='mt-10 flex flex-col items-center justify-between gap-4 border-t border-zinc-800/50 pt-6 sm:flex-row'>
                        ...
                        <div className='flex gap-4'>
                            <a href='#' className='text-zinc-600 transition-colors hover:text-zinc-400'>
    ...
    return (
        <Slide>
            <div className='pointer-events-none absolute inset-0 overflow-hidden'>
                <div className='absolute left-1/2 top-0 h-[500px] w-[700px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-amber-500/[0.06] blur-[100px]' />
            </div>
            ...
            >
                <h1 className='mb-6 text-4xl font-bold leading-[1.1] tracking-tight text-white sm:text-5xl md:text-6xl lg:text-7xl'>
                    ...
                    {' '}— ваша кальянная{' '}
                    <span className='text-zinc-400'>под контролем</span>
                </h1>
                ...
                <div className='flex flex-wrap items-center justify-center gap-4'>
                    <Button
                        size='lg'
                        className='h-11 bg-white text-black hover:bg-zinc-200 font-semibold px-7 gap-2 sm:h-12 sm:px-8'
                        onClick={onAction}
                    >
                ...
                {/* Статистика */}
                <div className='mt-14 grid grid-cols-3 gap-6 border-t border-zinc-800/50 pt-10 sm:gap-8'>
                    {STATS.map((s, i) => (
                        <div
                            key={s.label}
                ...
                >
                    <div className='rounded-xl border border-zinc-800/60 bg-zinc-900/50 p-4 text-left backdrop-blur-sm sm:p-5'>
                        <div className='mb-3 flex items-center justify-between'>
                            <span className='text-xs font-medium text-zinc-400'>Сегодня</span>
...
function MiniBooking({time, name, places}: {time: string; name: string; places: number}) {
    return (
        <div className='flex items-center justify-between rounded-lg bg-zinc-800/40 px-3 py-2'>
            ...
            <span className='text-xs text-zinc-500'>{places} мест</span>
        </div>
    );
}
...
function FeaturesSlide() {
    ...
    return (
        <section id='features' ref={ref} className='relative border-t border-zinc-800/50'>
...
function BenefitsSlide() {
    ...
    return (
        <section id='benefits' className='border-t border-zinc-800/50 bg-zinc-900/20'>
                ...
                <div className='grid gap-4 sm:grid-cols-2 lg:grid-cols-3'>
                    {BENEFITS.map((b, i) => {
                        ...
                        return (
                            <div
                                key={b.title}
                                className={`flex gap-4 rounded-xl border border-zinc-800/40 p-5 transition-all duration-500 hover:border-zinc-700/60 hover:bg-zinc-900/40 ${
                                    visible ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'
                                }`}
                            ...
                            >
                                ...
                                <div>
                                    <h3 className='mb-1 text-sm font-medium text-zinc-200'>{b.title}</h3>
